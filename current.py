...
template = open('/usr/local/www/nginx/template.html', 'r')
...
output = output.replace('BETALINK', '')
...
outputhndl = open('/usr/local/www/nginx/inside.html', 'w')
outputhndl.write(output_dark)
outputhndl.close()
outputhndl = open('/usr/local/www/nginx/index.html', 'w')
outputhndl.write(output_dark)
outputhndl.close()

outputhndl = open('/usr/local/www/nginx/lighter_inside.html', 'w')
outputhndl.write(output_light)
outputhndl.close()
outputhndl = open('/usr/local/www/nginx/lighter.html', 'w')
outputhndl.write(output_light)
outputhndl.close()
